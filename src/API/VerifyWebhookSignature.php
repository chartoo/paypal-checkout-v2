...
class VerifyWebhookSignature
{
    ...
    {
        $_SESSION['transmission_id'] = $transmission_id;
        return $this;
    }
    ...
    {
        return $_SESSION['transmission_id'];
    }
    ...
    {
        $_SESSION['transmission_sig'] = $transmission_sig;
        return $this;
    }
    ...
    {
        return $_SESSION['transmission_sig'];
    }
    ...
    {
        $_SESSION['transmission_time'] = $transmission_time;
        return $this;
    }
    ...
    {
        return $_SESSION['transmission_time'];
    }
    ...
    {
        $_SESSION['webhook_id'] = $webhook_id;
        return $this;
    }
    ...
    {
        $_SESSION['webhook_event'] = $webhook_event;
        return $this;
    }
    ...
    {
        if (!is_null($_SESSION['request_body'])) {
            $valuesToEncode = $_SESSION;
            ...
            $payLoad .= "\"webhook_event\":".$_SESSION['request_body'];
            $payLoad .= "}";
            return $payLoad;
        } else {
